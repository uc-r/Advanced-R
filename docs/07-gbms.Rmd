...
- Determines just how "weak" our base learning is

- Deeper trees are more prone to overfitting 

- But stumps don't all you to catch interactions
...
```{r num-trees2, echo=FALSE, eval=FALSE}
